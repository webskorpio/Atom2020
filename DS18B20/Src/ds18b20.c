...

{
  ...
  Delay(490);//задержка как минимум на 480 микросекунд
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_11, GPIO_PIN_SET);
  //GPIOB->ODR |= GPIO_ODR_ODR11;//высокий уровень
  Delay(70);//задержка как минимум на 60 микросекунд
  ...
  Delay(500);//задержка как минимум на 480 микросекунд
...
uint8_t ds18b20_ReadBit(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_11, GPIO_PIN_SET);
  Delay(13);
  bit = (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_11) ? 1 : 0);//провер€ем уровень
  Delay(45);
  return bit;
}
//-----------------------------------------------
